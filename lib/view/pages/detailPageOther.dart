              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(menuother[widget.index].image),
                        fit: BoxFit.cover)),
                child: Container(
                  decoration: BoxDecoration(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          itemCount: menuother[widget.index].rate,
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              menuother[widget.index].price.toString(),
                              style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 25,
                                  fontWeight: FontWeight.bold),
